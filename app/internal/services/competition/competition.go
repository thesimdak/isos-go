...
func (svc *CompetitionService) UploadResults(file multipart.File) {
	...
	categoryVII := svc.CategoryRepo.EnsureCategory(loaders.KatVII, "Mladší žáci", 4.5)
	categoryVIII := svc.CategoryRepo.EnsureCategory(loaders.KatVIII, "Mladší žákyně", 4.5)
